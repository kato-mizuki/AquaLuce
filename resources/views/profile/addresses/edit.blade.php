...
<div class="container mt-5">
    ...
    <form action="{{ route('addresses.update', $address->id) }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" id="prefecture" name="prefecture" class="form-control" value="{{ old('prefecture', $address->prefecture) }}" required>
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" id="town" name="town" class="form-control" value="{{ old('town', $address->town) }}" required>
        </div>

        <div class="mb-3">
            <label for="building" class="form-label">建物名・部屋番号（任意）</label>
            <input type="text" id="building" name="building" class="form-control" value="{{ old('building', $address->building) }}">
        </div>
